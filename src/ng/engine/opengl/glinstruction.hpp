...
enum class OpenGLOpCode : decltype(OpenGLInstruction().OpCode)
{
    ...
    // notes:
    //         * the promised OpenGLBuffer will be created by glGenBuffers.
    ...
    //         1) OpenGLShaderProgram* program
    //         2) RenderFlags renderFlags
    //         3) GLenum primitiveType
    //         4) GLint firstVertexIndex
    //         5) GLsizei vertexCount
    // notes:
    //         * will render the vertices specified in vertexArray using program.
