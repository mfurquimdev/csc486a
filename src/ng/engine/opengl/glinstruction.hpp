...
{
    std::unique_ptr<std::promise<OpenGLBufferHandle>> BufferPromise;

    bool AutoCleanup;

    GenBufferOpCodeParams(std::unique_ptr<std::promise<OpenGLBufferHandle>> bufferPromise, bool autoCleanup);
